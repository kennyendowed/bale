 ...
 <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{ url('admin/inventory-page') }}" class="waves-effect"><i class="fas fa-table"></i>Inventory</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/show-food') }}" class="waves-effect"><i class="fas fa-table"></i>Product list</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/Packs') }}" class="waves-effect"><i class="fas fa-table"></i>Packs</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/change-slider-image') }}" class="waves-effect"><i class="fas fa-table"></i>Upload Slider</a>
                    </li>
                    {{-- <li>
                        <a href="{{ url('admin/category') }}" class="waves-effect"><i class="fas fa-table"></i>categories</a>
                    </li> --}}
